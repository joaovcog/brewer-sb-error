...
public class VendaValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		validarDataEntrega(errors, venda);
		validarExistenciaItens(errors, venda);
	...
	private void validarExistenciaItens(Errors errors, Venda venda) {
		if (venda.getItens().isEmpty()) {
			errors.reject("", "Adicione pelo menos uma cerveja na venda.");
		}
	}

	private void validarDataEntrega(Errors errors, Venda venda) {
